    ...
    const handleCompleteRegistration = async (e) => {
        ...
        if (mpin === confirmMpin && mpin.length === 4) {
            ...
            const userData = {
                ...
                email: googleUser?.email || `user_${phone}@smartbank.env`,
                displayName: googleUser?.displayName || "SmartBank User",
                phone,
                mpin,
            };
            ...
            <AnimatePresence mode="wait">
                {step === 1 && (
                    ...
                    >
                        ...
                        <h2 className="title">SmartBank Security</h2>
                        <p className="subtitle">Choose an account to get started</p>
                        ...
                        <button className="btn-google full-width" onClick={handleGoogleLogin} disabled={loading}>
                            {loading
                                ...
                                : <><img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" width={20} />Sign in with Google</>
                            }
                        </button>
                ...
                {step === 2 && (
                    ...
                    >
                        ...
                        <p className="subtitle">Hi {googleUser?.displayName}, enter your mobile number</p>
                        <form onSubmit={handleSendOtp}>
                             <div className="input-group">
                                <span className="prefix">+91</span>
                                <input 
                ...
                {step === 3 && (
                    ...
                    >
                        ...
                        <form onSubmit={handleVerifyOtp}>
                            ...
                            <p className="resend">Resend OTP in <b>00:45</b></p>
                        </form>
                    </motion.div>
                )}
                ...
                {step === 4 && (
                    ...
                    >
                        ...
                        <h2 className="title">Set Your MPIN</h2>
                        <p className="subtitle">Secure your account with a 4-digit PIN</p>
                        ...
                        <form onSubmit={handleCompleteRegistration}>
                            ...
                            {mpin.length === 4 && confirmMpin.length === 4 && mpin !== confirmMpin && (
                                <p style={{ color: 'red', fontSize: '0.8rem', textAlign: 'center', marginBottom: '10px' }}>PINs do not match</p>
                            )}
